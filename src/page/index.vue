  ...
  <div class="container">
    ...
    <section class="hero-section" ref="heroSection" @mousemove="handleMouseMove" @mouseleave="resetTextRotation">
      ...
      <div class="hero-wrapper">
        <div class="hero-text-3d" :style="text3DStyle">
          <span class="hero-greeting">HELLO，I'm ZZZ-zz</span>
        </div>
        ...
        <div class="hero-actions">
          <a class="hero-link" :href="portfolio.githubUrl" target="_blank">GitHub</a>
          <a class="hero-link" :href="portfolio.resumeUrl" target="_blank">查看简历</a>
        </div>
      </div>
    </section>
            ...
            <FlipCard class="card-item">
              <template #front>
                <div class="card-front">
                  ...
                  <h3>基本信息</h3>
                  <p>郑瞄瞄 · 22岁 · 女</p>
                  <p class="front-summary">求职前端开发</p>
                </div>
              </template>
              <template #back>
                <div class="card-back">
                  ...
                  <div class="info-grid info-grid-large">
                    <div class="info-item" v-for="item in basicInfo" :key="item.label">
                      ...
                      <span v-if="item.label === '邮箱'" class="info-value">
            ...
            <FlipCard class="card-item">
              <template #front>
                <div class="card-front">
                  ...
                  <h3>教育背景</h3>
                  <p>郑州轻工业大学</p>
                  <p class="front-summary">网络工程 · 2026届</p>
                </div>
              </template>
              <template #back>
                <div class="card-back">
              ...
              <FlipCard class="card-item">
                <template #front>
                  <div class="card-front">
                    ...
                    <h3>自我评价</h3>
                    <p>技术扎实 · 热爱学习</p>
                    <p class="front-summary">团队荣誉感强</p>
                  </div>
                </template>
                <template #back>
                  <div class="card-back">
                ...
                <template #front>
                  <div class="card-front skill-front">
                    ...
                    <div class="skill-summary">
                      <div class="summary-item">✓ Vue 2/3 全家桶 + TypeScript</div>
                      <div class="summary-item">✓ uni-app 跨端开发 (Pad/H5/小程序)</div>
                ...
                <template #back>
                  <div class="card-back skill-back">
                    ...
                    <div class="skill-list-full">
                      <div class="skill-item-full" v-for="(skill, idx) in skills" :key="idx">
                ...
                <template #front>
                  <div class="card-front">
                    ...
                    <div class="keyword-preview">
                      <span v-for="kw in personalKeywords.slice(0,4)" :key="kw">{{ kw }}</span>
                    </div>
                  </div>
                </template>
                <template #back>
    ...
    <section class="content-section" ref="archivesSection" id="archives">
      <div class="section-container">
        ...
        <div class="search-bar">
          <el-input v-model="searchKeyword" placeholder="搜索文章..." clearable prefix-icon="el-icon-search"></el-input>
        </div>
    ...
    <section class="content-section" ref="categoriesSection" id="categories">
      <div class="section-container">
        ...
        <div class="section">
          <div class="subsection-title"><i class="el-icon-suitcase"></i> 实习经历</div>
        ...
        <div class="section">
          <div class="subsection-title"><i class="el-icon-folder-opened"></i> 项目经历</div>
...
export default {
  ...
  data() {
    return {
      ...
      activeSection: 'about',
      navItems: [
        { key: 'about', label: '关于', icon: 'el-icon-s-home' },
        { key: 'archives', label: '博客文章', icon: 'el-icon-folder-opened' },
        { key: 'categories', label: '项目/实习', icon: 'el-icon-paperclip' }
      ],
      portfolio: {
      ...
      rotateX: 0,
      rotateY: 0,
      text3DStyle: { transform: 'rotateX(0deg) rotateY(0deg)' },
      tagOffsets: []   // 存储每个标签的随机上下偏移量
    }
  },
  computed: {
    filteredBlogs() {
